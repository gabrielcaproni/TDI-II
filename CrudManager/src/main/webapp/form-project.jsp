		...
		<div id="container" class="container-fluid">
			...
			<form action="${pageContext.request.contextPath}/project/${action}" method="POST">
				...
				<div class="row">
					...
					<div class="form-group col-md-6">
						<label for="project_start_date">Data de Início</label>
							<input type="date" class="form-control" id="project_start_date" name="project_start_date" 
								  ...
								  oninput="setCustomValidity('')"
								  value="${projectEdit.getStartDate()}"
								  >
					</div>
					
					<div class="form-group col-md-6">
						<label for="project_end_date">Data de Término</label>
							...
							<select id="project_company" class="form-control selectpicker" name="project_company" 
							  ...
							  <c:forEach var="company" items="${companies}">
							  	<option value="${company.getId()}" 
							  		${projectEdit.getCompanyId() eq company.getId() 
							  		? "selected" : ""}>
							  		${company.getName()}
							  	</option>	
							  </c:forEach>
